...
/search - البحث باستخدام رقم الهوية أو الاسم
        ...
        const aboutMessage = `
📖 **معلومات عن البوت:**
أنا بوت تليجرام مخصص للبحث عن نتائج الطلاب باستخدام ملف Excel. يمكنك البحث باستخدام رقم الهوية أو الاسم للوصول إلى التفاصيل المطلوبة.
        `;
        bot.sendMessage(chatId, aboutMessage, { parse_mode: 'Markdown' });
    } else if (query.data === 'contact') {
        const contactMessage = `
📞 **معلومات الاتصال:**
للمزيد من الدعم، يمكنك التواصل مع فريق الدعم عبر البريد الإلكتروني: support@example.com
        `;
